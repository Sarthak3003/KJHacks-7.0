...
const Gst = () => {
  ...
  const data = {
    aadhaar_linked: 'Yes',
    centerJurisdiction:
      'Commissionerate - PUNE - I,Division - DIVISION-II PIMPRI,Range - RANGE-V ,(Jurisdictional Office)',
    ...
    principalPlaceOfBusinessAddress:
      'TATA MOTORS LIMITED, Nigadi Bhosari Road, PIMPRI, Pune, Maharashtra, 411018',
    stateJurisdiction:
      'State - Maharashtra,Zone - Pune,Division - PUNE-LTU-2,Charge - PUNE_LTU_524',
  ...
  const submit = async () => {
    ...
    // fetch("https://bdd0-182-76-21-121.in.ngrok.io/account/gstverify/", requestOptions)
