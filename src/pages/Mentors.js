    ...
    <div>
      <div className="bg-white flex flex-col items-center self-center max-w-[280px] bottom-[-40px] p-2 rounded-b-2xl shadow-lg">
        <img
          src={
            mentor?.profile_pic
              ? `https://bdd0-182-76-21-121.in.ngrok.io/${mentor.profile_pic}`
...
export default function Mentors() {
  ...
  const getMentorsList = async () => {
    var config = {
      method: 'get',
      url: 'https://bdd0-182-76-21-121.in.ngrok.io/account/mentors_list/',
      headers: {
  ...
  const getSearchedMentors = async () => {
    ...
    var config = {
      method: 'post',
      url: 'https://bdd0-182-76-21-121.in.ngrok.io/account/search_mentors/',
      headers: {
        Authorization: `Token ${token}`,
      },
      data: formData,
